...
#include "src/jzzH/jazzWebSource.h"
...
TEST_CASE("Assertions on http constants")
{
	REQUIRE(!strcmp(HTTP_LANGUAGE_STRING[LANG_EN_US], "en-US"));
	REQUIRE(!strcmp(HTTP_LANGUAGE_STRING[LANG_ES_ES], "es-ES"));
	REQUIRE(!strcmp(HTTP_LANGUAGE_STRING[LANG_FR_FR], "fr-FR"));
	REQUIRE(!strcmp(HTTP_LANGUAGE_STRING[LANG_DE_DE], "de-DE"));
	REQUIRE(!strcmp(HTTP_LANGUAGE_STRING[LANG_IT_IT], "it-IT"));
	REQUIRE(!strcmp(HTTP_LANGUAGE_STRING[LANG_TR_TR], "tr-TR"));
	REQUIRE(!strcmp(HTTP_LANGUAGE_STRING[LANG_LAST_], "@the_last@"));

	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_C_BOOL],		   "application/octet-stream"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_C_OFFS_CHARS],  "application/octet-stream"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_C_FACTOR],	   "application/octet-stream"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_C_GRADE],	   "application/octet-stream"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_C_INTEGER],	   "application/octet-stream"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_C_TIMESEC],	   "application/octet-stream"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_C_REAL],		   "application/octet-stream"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_ANYTHING],  "application/octet-stream"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_STRINGS],   "text/plain; charset=utf-8"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_R_RAW],	   "application/octet-stream"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_MIME_APK],  "application/vnd.android.package-archive"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_MIME_CSS],  "text/css"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_MIME_CSV],  "text/csv"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_MIME_GIF],  "image/gif"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_MIME_HTML], "text/html"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_MIME_IPA],  "application/octet-stream"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_MIME_JPG],  "image/jpeg"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_MIME_JS],   "application/javascript"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_MIME_JSON], "application/json"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_MIME_MP4],  "video/mp4"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_MIME_PDF],  "application/pdf"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_MIME_PNG],  "image/png"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_MIME_TSV],  "text/tab-separated-values"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_MIME_TXT],  "text/plain"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_MIME_XAP],  "application/x-silverlight-app"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_MIME_XML],  "application/xml"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_RAW_MIME_ICO],  "image/x-icon"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_FUN_R],		   "text/plain"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_FUN_DFQL],	   "text/plain"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_FUN_DFQO],	   "application/jazz-vm"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_ALL_ROLES],	   "application/jazz-binary"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_ALL_KEYSPACE],  "application/jazz-binary"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_ALL_SECURITY],  "application/jazz-binary"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_MY_LOG_EVENTS], "application/jazz-binary"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_MY_PROFILING],  "application/jazz-binary"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_MY_SECURITY],   "application/jazz-binary"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_MY_URL_DICT],   "application/jazz-binary"));
	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_SOURCE_ATTRIB], "application/jazz-binary"));

	REQUIRE(!strcmp(HTTP_MIMETYPE_STRING[BLOCKTYPE_LAST_], "application/jazz-binary"));
}
